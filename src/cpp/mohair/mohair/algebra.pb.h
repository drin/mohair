...
inline const ::google::protobuf::RepeatedField<::uint32_t>& SkyRel::_internal_slices() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
...
inline void SkyRel::set_allocated_execstats(::mohair::ExecutionStats* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::mohair::ExecutionStats*>(value));
