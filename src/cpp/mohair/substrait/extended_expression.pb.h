...
class ExpressionReference final :
 ...
 public:
  ...
  inline ExpressionReference(const ExpressionReference& from)
      : ExpressionReference(nullptr, from) {}
...
class ExtendedExpression final :
 ...
 public:
  ...
  inline ExtendedExpression(const ExtendedExpression& from)
      : ExtendedExpression(nullptr, from) {}
...
inline ::substrait::Expression* ExpressionReference::_internal_mutable_expression() {
  if (expr_type_case() != kExpression) {
    clear_expr_type();
    set_has_expression();
    _impl_.expr_type_.expression_ = CreateMaybeMessage<::substrait::Expression>(GetArena());
  }
...
inline ::substrait::AggregateFunction* ExpressionReference::_internal_mutable_measure() {
  if (expr_type_case() != kMeasure) {
    clear_expr_type();
    set_has_measure();
    _impl_.expr_type_.measure_ = CreateMaybeMessage<::substrait::AggregateFunction>(GetArena());
  }
...
inline ::substrait::Version* ExtendedExpression::_internal_mutable_version() {
  ...
  if (_impl_.version_ == nullptr) {
    auto* p = CreateMaybeMessage<::substrait::Version>(GetArena());
