...
PROTOBUF_NAMESPACE_OPEN
template <>
::substrait::NamedStruct* Arena::CreateMaybeMessage<::substrait::NamedStruct>(Arena*);
template <>
::substrait::Type* Arena::CreateMaybeMessage<::substrait::Type>(Arena*);
template <>
::substrait::Type_Binary* Arena::CreateMaybeMessage<::substrait::Type_Binary>(Arena*);
template <>
::substrait::Type_Boolean* Arena::CreateMaybeMessage<::substrait::Type_Boolean>(Arena*);
template <>
::substrait::Type_Date* Arena::CreateMaybeMessage<::substrait::Type_Date>(Arena*);
template <>
::substrait::Type_Decimal* Arena::CreateMaybeMessage<::substrait::Type_Decimal>(Arena*);
template <>
::substrait::Type_FP32* Arena::CreateMaybeMessage<::substrait::Type_FP32>(Arena*);
template <>
::substrait::Type_FP64* Arena::CreateMaybeMessage<::substrait::Type_FP64>(Arena*);
template <>
::substrait::Type_FixedBinary* Arena::CreateMaybeMessage<::substrait::Type_FixedBinary>(Arena*);
template <>
::substrait::Type_FixedChar* Arena::CreateMaybeMessage<::substrait::Type_FixedChar>(Arena*);
template <>
::substrait::Type_I16* Arena::CreateMaybeMessage<::substrait::Type_I16>(Arena*);
template <>
::substrait::Type_I32* Arena::CreateMaybeMessage<::substrait::Type_I32>(Arena*);
template <>
::substrait::Type_I64* Arena::CreateMaybeMessage<::substrait::Type_I64>(Arena*);
template <>
::substrait::Type_I8* Arena::CreateMaybeMessage<::substrait::Type_I8>(Arena*);
template <>
::substrait::Type_IntervalDay* Arena::CreateMaybeMessage<::substrait::Type_IntervalDay>(Arena*);
template <>
::substrait::Type_IntervalYear* Arena::CreateMaybeMessage<::substrait::Type_IntervalYear>(Arena*);
template <>
::substrait::Type_List* Arena::CreateMaybeMessage<::substrait::Type_List>(Arena*);
template <>
::substrait::Type_Map* Arena::CreateMaybeMessage<::substrait::Type_Map>(Arena*);
template <>
::substrait::Type_Parameter* Arena::CreateMaybeMessage<::substrait::Type_Parameter>(Arena*);
template <>
::substrait::Type_String* Arena::CreateMaybeMessage<::substrait::Type_String>(Arena*);
template <>
::substrait::Type_Struct* Arena::CreateMaybeMessage<::substrait::Type_Struct>(Arena*);
template <>
::substrait::Type_Time* Arena::CreateMaybeMessage<::substrait::Type_Time>(Arena*);
template <>
::substrait::Type_Timestamp* Arena::CreateMaybeMessage<::substrait::Type_Timestamp>(Arena*);
template <>
::substrait::Type_TimestampTZ* Arena::CreateMaybeMessage<::substrait::Type_TimestampTZ>(Arena*);
template <>
::substrait::Type_UUID* Arena::CreateMaybeMessage<::substrait::Type_UUID>(Arena*);
template <>
::substrait::Type_UserDefined* Arena::CreateMaybeMessage<::substrait::Type_UserDefined>(Arena*);
template <>
::substrait::Type_VarChar* Arena::CreateMaybeMessage<::substrait::Type_VarChar>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& Type_Nullability_Name(Type_Nullability value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<Type_Nullability_descriptor,
                                                 0, 2>(
...
class Type_Struct final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::substrait::Type>& _internal_types() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::substrait::Type>* _internal_mutable_types();
  public:
...
class Type final :
 ...
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Nullability_descriptor() {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* NamedStruct::mutable_names() {
