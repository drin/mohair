...
class Capabilities_SimpleExtension final :
 ...
 public:
  ...
  inline Capabilities_SimpleExtension(const Capabilities_SimpleExtension& from)
      : Capabilities_SimpleExtension(nullptr, from) {}
...
class Capabilities final :
 ...
 public:
  ...
  inline Capabilities(const Capabilities& from)
      : Capabilities(nullptr, from) {}
