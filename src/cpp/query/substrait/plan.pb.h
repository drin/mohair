...
class Version final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:substrait.Version) */ {
 public:
...
class PlanVersion final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:substrait.PlanVersion) */ {
 public:
  inline PlanVersion() : PlanVersion(nullptr) {}
  ~PlanVersion() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR PlanVersion(::google::protobuf::internal::ConstantInitialized);

  inline PlanVersion(const PlanVersion& from)
      : PlanVersion(nullptr, from) {}
...
class PlanRel final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:substrait.PlanRel) */ {
 public:
  inline PlanRel() : PlanRel(nullptr) {}
  ~PlanRel() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR PlanRel(::google::protobuf::internal::ConstantInitialized);

  inline PlanRel(const PlanRel& from)
      : PlanRel(nullptr, from) {}
...
class Plan final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:substrait.Plan) */ {
 public:
...
inline ::substrait::Rel* PlanRel::_internal_mutable_rel() {
  if (rel_type_case() != kRel) {
    clear_rel_type();
    set_has_rel();
    _impl_.rel_type_.rel_ = CreateMaybeMessage<::substrait::Rel>(GetArena());
  }
...
inline ::substrait::RelRoot* PlanRel::_internal_mutable_root() {
  if (rel_type_case() != kRoot) {
    clear_rel_type();
    set_has_root();
    _impl_.rel_type_.root_ = CreateMaybeMessage<::substrait::RelRoot>(GetArena());
  }
...
inline void Plan::set_allocated_version(::substrait::Version* value) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast<::substrait::Version*>(_impl_.version_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::substrait::Version*>(value)->GetArena();
