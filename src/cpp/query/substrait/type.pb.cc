...
static ::_pb::Metadata file_level_metadata_substrait_2ftype_2eproto[29];
...
::google::protobuf::Metadata Type_Boolean::GetMetadata() const {
  return ::_pbi::AssignDescriptors(&descriptor_table_substrait_2ftype_2eproto_getter,
                                   &descriptor_table_substrait_2ftype_2eproto_once,
...
const char* Type_PrecisionTimestamp::_InternalParse(
    const char* ptr, ::_pbi::ParseContext* ctx) {
  ptr = ::_pbi::TcParser::ParseLoop(this, ptr, ctx, &_table_.header);
  return ptr;
}
...
PROTOBUF_NOINLINE bool Type_PrecisionTimestamp::IsInitialized() const {
  return true;
}
...
const char* Type_PrecisionTimestampTZ::_InternalParse(
    const char* ptr, ::_pbi::ParseContext* ctx) {
  ptr = ::_pbi::TcParser::ParseLoop(this, ptr, ctx, &_table_.header);
  return ptr;
}
...
PROTOBUF_NOINLINE bool Type_PrecisionTimestampTZ::IsInitialized() const {
  return true;
}
