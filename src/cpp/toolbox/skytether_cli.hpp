...
// >> Internal dependencies for connecting to skytether services
...
namespace skytether::cli {

  // Support functions
  vector<string> GetUriSchemeWhitelist();

  // CLI arg parsing prototypes
  int ParseArgLocationUri(const char* arg_loc_uri, skytether::services::Location* out_srvloc);
